        ...
        while True:
            ...
            if (edad.isnumeric()):
                ...
                if (edad > 17 and edad < 90):
                    break
        while True:
            estado_civil = prompt("Datos", "Ingrese su estado civil (Casado/Soltero/Divorciado/Viudo)")
            if (estado_civil == "Soltero" or estado_civil == "Casado" or estado_civil == "Divorciado" or estado_civil == "Viudo"):
                break
        while True:
            numero_legajo = prompt("Datos" , "Numero de legajo")
            if (len(numero_legajo) == 4):
                numero_legajo = int(numero_legajo)
                if (numero_legajo > 1000):
                    break
