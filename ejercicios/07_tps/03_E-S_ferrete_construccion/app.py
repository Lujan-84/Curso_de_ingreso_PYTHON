...
class App(customtkinter.CTk):
    ...
    def btn_calcular_on_click(self):
        ...
        largo = float(largo)
        ancho = float(ancho)
        perimetro_terreno = 2*ancho + 2*largo
        area_terreno = ancho*largo
        quebracho_grueso = perimetro_terreno // 250 + 4
        quebracho_fino = perimetro_terreno // 12 - quebracho_grueso
        varillas = perimetro_terreno // 2
        alambre = perimetro_terreno * 7
        mensaje = f"""El terreno tiene {area_terreno} metros cuadrados. 
        Su perimetro es de {perimetro_terreno} metros.
        La cantidad necesaria de qubracho Grueso es: {quebracho_grueso}
        La cantidad necesaria de qubracho Fino es: {quebracho_fino}
        La cantidad necesaria de varillas es: {varillas}
        La cantidad necesaria de alambre es: {alambre}"""
