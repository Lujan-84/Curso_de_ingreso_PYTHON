...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        resultado_en_fahrenheit = temperatura_celsius * (9/5) + 32 
        mensaje = "La temperatura es: " + str(resultado_en_fahrenheit) + " °F"
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        resultado_en_celsius = (temperatura_fahrenheit - 32) * (5/9) 
        mensaje = "La temperatura es: " + str(resultado_en_celsius) + " °C"
        alert("Mensaje" , mensaje)
